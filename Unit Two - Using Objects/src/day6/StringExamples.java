...
public class StringExamples {
    public static void main(String[] args) {
        ...
        System.out.println("abcdzz".compareTo("abcdz"));        // if number of letters in a word is greater than the other one then it counds the amount of letters
    }
}