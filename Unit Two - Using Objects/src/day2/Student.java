...
public class Student {
    ...
    // Constructor, always the same name as the class
    // Constructor --> to create an instance of the class (Object) and set the initial state of the object's attributes
    ...
    // Methods --> the stuff in the (round brackets) are the arguments / parameters -- method and constructor require the arguments to work
